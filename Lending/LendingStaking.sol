...
library SafeMath {
    ...
    function add(uint256 a, uint256 b) internal pure returns (uint256) {
        uint256 c = a + b;
        require(c >= a, "MasterChef: addition overflow");
        return c;
    }
    ...
    function sub(uint256 a, uint256 b) internal pure returns (uint256) {
        require(b <= a, "MasterChef: subtraction overflow");
        return a - b;
    }
    ...
    function mul(uint256 a, uint256 b) internal pure returns (uint256) {
        if (a == 0) return 0;
        uint256 c = a * b;
        require(c / a == b, "MasterChef: multiplication overflow");
        return c;
    }
    ...
    function div(uint256 a, uint256 b) internal pure returns (uint256) {
        require(b > 0, "MasterChef: division by zero");
        return a / b;
    }
    ...
    function mod(uint256 a, uint256 b) internal pure returns (uint256) {
        require(b > 0, "MasterChef: modulo by zero");
        return a % b;
    }
...
contract HBTLendingStaking is Ownable, ReentrancyGuard {
    ...
    function setLendingManager(address addr) public onlyOwner{
        lendingManager = addr;
    }
    ...
    function deposit(uint256 _amount) public  {
        ...
        require(!user.hasTakenLoan,"Cannot stake more before clearing the loan");
